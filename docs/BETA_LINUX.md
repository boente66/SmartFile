# SmartFile 0.9.0 Beta 4 — Linux amd64
...
[Download direto do SmartFile Linux amd64](https://github.com/boente66/SmartFile/releases/download/v0.9.0-beta.4/smartfile_0.9.0.beta4_amd64.deb)

O arquivo baixado deve se chamar `smartfile_0.9.0.beta4_amd64.deb`. Um download
...
file smartfile_0.9.0.beta4_amd64.deb
dpkg-deb --info smartfile_0.9.0.beta4_amd64.deb
...
`smartfile_0.9.0~beta4_amd64.deb`; o GitHub normaliza o caractere `~` no nome do
asset, mas a versão interna do pacote continua sendo `0.9.0~beta4`.
